...
void test_transpose_int_4()
{
	...
	for (int i = 0; i < m2.GetDescriptor().GetDim( 0 ); i++) {
		for (int j = 0; j < m2.GetDescriptor().GetDim( 1 ); j++)
			m2(i,j) = int(j*m1.GetDescriptor().GetDim( 1 ) + i + 1)/10;
	}
...
// small matrix
void test_transpose_int_5() 
{	
	Array<int> m1(sizeSmall, 2*sizeSmall);
	for (int i = 0; i < m1.GetDescriptor().GetDim( 0 ); i++) {
		for (int j = 0; j < m1.GetDescriptor().GetDim( 1 ); j++)
			m1(i,j) = int(i*m1.GetDescriptor().GetDim( 1 ) + j + 1)/10;
	}

	Array<int> m2(2*sizeSmall, sizeSmall);
	for (int i = 0; i < m2.GetDescriptor().GetDim( 0 ); i++) {
		for (int j = 0; j < m2.GetDescriptor().GetDim( 1 ); j++)
			m2(i,j) = int(j*m2.GetDescriptor().GetDim( 0 ) + i + 1)/10;
	}
...
// large matrix
void test_transpose_int_6()
{
	Array<int> m1(sizeLarge, 2*sizeLarge);
	for (int i = 0; i < m1.GetDescriptor().GetDim( 0 ); i++) {
		for (int j = 0; j < m1.GetDescriptor().GetDim( 1 ); j++)
			m1(i,j) = int(i*m1.GetDescriptor().GetDim( 1 ) + j + 1)/10;
	}

	Array<int> m2(2*sizeLarge, sizeLarge);
	for (int i = 0; i < m2.GetDescriptor().GetDim( 0 ); i++) {
		for (int j = 0; j < m2.GetDescriptor().GetDim( 1 ); j++)
			m2(i,j) = int(j*m1.GetDescriptor().GetDim( 1 ) + i + 1)/10;
	}
...
{	
	...
	for (int i = 0; i < m2.GetDescriptor().GetDim( 0 ); i++) {
		for (int j = 0; j < m2.GetDescriptor().GetDim( 1 ); j++)
			m2(i,j) = int(i*m2.GetDescriptor().GetDim( 1 ) + j + 1)/10;
	}
...
{	
	...
	Array<int> m2(sizeSmall, 2*sizeSmall);
	for (int i = 0; i < m2.GetDescriptor().GetDim( 0 ); i++) {
		for (int j = 0; j < m2.GetDescriptor().GetDim( 1 ); j++)
			m2(i,j) = int(i*m2.GetDescriptor().GetDim( 1 ) + j + 1)/10;
	}
...
void test_conjugate_int_6() 
{
	...
	Array<int> m2(sizeLarge, 2*sizeLarge);
	for (int i = 0; i < m2.GetDescriptor().GetDim( 0 ); i++) {
		for (int j = 0; j < m2.GetDescriptor().GetDim( 1 ); j++)
			m2(i,j) = int(i*m2.GetDescriptor().GetDim( 1 ) + j + 1)/10;
	}
...
{	
	...
	for (int i = 0; i < m2.GetDescriptor().GetDim( 0 ); i++) {
		for (int j = 0; j < m2.GetDescriptor().GetDim( 1 ); j++)
			m2(i,j) = int(j*m2.GetDescriptor().GetDim( 1 ) + i + 1)/10;
	}
