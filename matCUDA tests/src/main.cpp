...
init_unit_test_suite( int argc, char* argv[] )
{
	...
	// UnitTest23.cpp
	ts1->add( BOOST_TEST_CASE( &test_abs_complex_1 ) );
	ts1->add( BOOST_TEST_CASE( &test_abs_complex_2 ) );
	ts1->add( BOOST_TEST_CASE( &test_abs_complex_3 ) );
	ts1->add( BOOST_TEST_CASE( &test_abs_complex_4 ) );
	ts1->add( BOOST_TEST_CASE( &test_abs2_complex_1 ) );
	ts1->add( BOOST_TEST_CASE( &test_abs2_complex_2 ) );
	ts1->add( BOOST_TEST_CASE( &test_abs2_complex_3 ) );
	ts1->add( BOOST_TEST_CASE( &test_abs2_complex_4 ) );
