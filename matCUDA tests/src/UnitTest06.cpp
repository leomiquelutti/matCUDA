...
void test_times_int_1() 
{
	...
	if(scalar3 != scalar4)
		BOOST_FAIL("scalar3 != scalar4!!!");
}

void test_times_int_2() 
{
...
// v*v.tranpose() = matrix
void test_times_int_3() 
{
	Array<int> v1(sizeSmall,1);
...
void test_times_int_7()
{
	...
	Array<int> v3(1,sizeSmall);
	Array<int> v4(1,sizeSmall);
...
void test_times_int_8()
{
	...
	Array<int> v3(1,sizeLarge);
	Array<int> v4(1,sizeLarge);
	for (int i = 0; i < v4.GetDescriptor().GetDim( 1 ); i++)
		v4(0,i) = sizeLarge;

	v3 = v1*m2;

	printf("v3(%d) = %d\n",sizeLarge,v3(0,sizeLarge-1));
